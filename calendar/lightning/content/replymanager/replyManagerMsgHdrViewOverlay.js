...
function showNotReplied() {
  let openDialogFunction = function(aGlodaMsg, aCollection, recipients) {
    ...
    window.openDialog("chrome://lightning/content/replyManagerShowAddressDialog.xul",
...
var replyManagerHdrViewWidget = {
  ...
  replyManagerMsgHdrViewPrefObserver: {
    ...
    onLoad: function()
    {
      Services.prefs.addObserver("calendar.replymanager.enabled", this, false);
    ...
    onUnload: function()
    {
      Services.prefs.removeObserver("calendar.replymanager.enabled", this);
    },
    ...
    observe: function(subject, topic, data)
    {
      ...
      switch(data)
      {
        case "calendar.replymanager.enabled":
          this.enableItems();
          replyManagerHdrViewWidget.hdrViewDeployItems();
          break;
      }
  ...
  hdrViewDeployItems: function() {
    ...
    if(!cal.getPrefSafe("calendar.replymanager.enabled", false) ||
       !GlodaIndexer.enabled ||
